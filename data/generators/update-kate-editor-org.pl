...
print $syntax_page
    ...
    "<p>Kate's highlighting is powered by the [KSyntaxHighlighting](https://api.kde.org/frameworks/syntax-highlighting/html/) framework and supports $count different languages.\n\n</p>".
    ...
    "<p>Submissions of new language definitions & examples are very welcome, head over to the [KSyntaxHighlighting repository README](https://invent.kde.org/frameworks/syntax-highlighting#introduction) for details.\n\n</p>".
...
print $themes_page
    ...
    "---\n\n".
    "<!-- This page is auto-generated by \"make update_kate_editor_org\" in syntax-highlighting.git -->\n\n".
    "<p>Kate's highlighting is powered by the [KSyntaxHighlighting](https://api.kde.org/frameworks/syntax-highlighting/html/) framework and ships with ".scalar(keys %themeToHTML)." pre-defined color themes.\n\n</p>".
    "<p>Below you can find a list of all bundled themes together with example renderings as HTML pages.\n\n</p>".
    "<table><tr><th>Name</th><th nowrap>Theme Examples</th></tr>\n";
foreach my $name (sort keys %themeToHTML) {
    my $file = $themeToHTML{$name};
    print $themes_page "<tr><td>$name</td>\n";
    print $themes_page "<td><a target=_blank href=\"/themes/$file\">HTML Example</a></td>";
    print $themes_page "</tr>\n";
}
print $themes_page "</table>\n";
close($themes_page);
